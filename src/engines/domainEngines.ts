...
export const domainEngines: Record<string, DomainEngine> = {
  ...
  'math': {
    ...
    solveTask: async () => 'x = 4',
    verifySolution: async () => 'Correct! 2(4) + 5 = 13',
    reflect: async () => 'This was a simple linear equation that required isolating the variable.',
  ...
  'writing': {
    ...
    verifySolution: async () => 'Concise, informative paragraph that covers key points about climate change.',
    reflect: async () => 'The paragraph effectively presents the problem and suggests solutions without being overly technical.',
  ...
  'business': {
    ...
    verifySolution: async () => 'Good strategy, covers key channels and target audience. Missing specific KPIs.',
    reflect: async () => 'The strategy has solid distribution channels but needs more specific success metrics and competitive differentiation.',

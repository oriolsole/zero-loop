...
export const domainEngines: Record<string, DomainEngine> = {
  ...
  'math': {
    ...
    mutateTask: async () => 'Solve for x: 3x - 7 = 20'
  },
  'writing': {
    generateTask: async () => 'Write a short paragraph about climate change.',
    generateSolution: async () => 'Climate change presents one of the most significant global challenges of our time. Rising temperatures, extreme weather events, and shifting ecosystems all point to the urgent need for coordinated action. By reducing carbon emissions and embracing sustainable practices, we can work toward mitigating its most severe impacts.',
    ...
    mutateTask: async () => 'Write a short paragraph comparing renewable and non-renewable energy sources.'
  },
  'business': {
    generateTask: async () => 'Outline a go-to-market strategy for a new productivity app.',
    generateSolution: async () => 'The go-to-market strategy will focus on: 1) Initial product launch targeting remote workers via social media and productivity forums 2) Free tier with premium upgrade path 3) Partnerships with established workflow tools 4) Content marketing emphasizing productivity gains 5) Targeted ads on professional networks',
